...
qualityValue.textContent=(quality.value||92)+"%";
width.addEventListener("input",()=>qualityPreset.value="custom");
height.addEventListener("input",()=>qualityPreset.value="custom");
...
qualityPreset.onchange=()=>{
  ...
  // Preset độ phân giải vẫn giữ chất lượng encoder ở mức cao.
